-- ============================================
-- @set9p | SILENT AIM (360°) + AUTO TRIGGER (RANDOM TARGET) + ESP + ANTI-AIM
-- ============================================
...
-- ============================
-- SILENT AIM & AUTO TRIGGER (СЛУЧАЙНЫЙ ВРАГ)
-- ============================
local function GetRandomPlayer()
    ...
    if #validTargets > 0 then
        -- Выбираем случайного врага из всех доступных по критериям
...
-- Мгновенный триггербот без задержек по рандомной цели
...
CombatTab:CreateToggle({
    Name = "Auto Trigger (Мгновенный рандом)",
    CurrentValue = false,
...
Rayfield:Notify({
    Title = "@set9p",
    Content = "Готово! Теперь выбор врага случайный.",
    Duration = 3,
    Image = 4483362458,
})