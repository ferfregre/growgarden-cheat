...
local ndsEnabled = false -- Единая функция (НДС)
local aimFOV = 200
local drawFOV = false
local fovCircle = nil
local target = nil
...
-- ============================
-- FOV КРУГ И НДС (НАВОДКА + СИМУЛЯЦИЯ ЛКМ)
-- ============================
...
-- ЕДИНАЯ ФУНКЦИЯ НДС
CombatTab:CreateToggle({
    Name = "НДС (Авто-клик по игроку в FOV)",
    CurrentValue = false,
    Flag = "NDSToggle",
