...
local Settings = {
    ...
    -- Auto Trigger & Visible Check (Режим спама)
    AutoTrigger = false,
    VisibleCheck = true,
...
-- ============================
-- SILENT AIM & AUTO TRIGGER (СПАМ РЕЖИМ)
-- ============================
local function GetClosestPlayer()
    ...
    for _, v in pairs(plrs) do
        ...
        -- Проверка видимости (если включена настройка)
...
RunService.RenderStepped:Connect(function()
    ...
    -- Режим непрерывного спама выстрелами
...
Rayfield:Notify({
    Title = "@set9p",
    Content = "Скрипт загружен: Auto Trigger (Спам) + Visible Check активны!",
    Duration = 3,
    Image = 4483362458,
})