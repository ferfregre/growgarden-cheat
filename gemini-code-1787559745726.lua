-- ============================================
-- @set9p | SILENT AIM (360°) + AUTO TRIGGER + VISIBLE CHECK + ESP + ANTI-AIM (DOWN)
-- ============================================
...
-- ============================
-- SILENT AIM & AUTO TRIGGER (С VISIBLE CHECK)
-- ============================
...
Rayfield:Notify({
    Title = "@set9p",
    Content = "Скрипт загружен: Auto Trigger + Visible Check активны!",
    Duration = 3,
    Image = 4483362458,
})