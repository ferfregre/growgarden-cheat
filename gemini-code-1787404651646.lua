-- ============================================
-- SWILL | FULL SCRIPT (WALLCAM + AIM + CONFIGS + WORLD COLOR)
-- ============================================
...
-- WORLD COLOR (ФИОЛЕТОВЫЙ / ЦВЕТНОЙ МИР)
...
-- ============================
-- ESP (С ПЕРЕЗАГРУЗКОЙ ПРИ СМЕРТИ)
-- ============================
...
ConfigTab:CreateButton({
    ...
    Callback = function()
        ...
        Rayfield:Notify({ Title = "Конфиги", Content = "Конфиг '" .. configNameInput .. "' сохранен!", Duration = 3 })
    end
})
...
ConfigTab:CreateButton({
    ...
    Callback = function()
        if loadConfig(configNameInput) then
            Rayfield:Notify({ Title = "Конфиги", Content = "Конфиг '" .. configNameInput .. "' загружен!", Duration = 3 })
        else
            Rayfield:Notify({ Title = "Конфиги", Content = "Конфиг не найден!", Duration = 3 })
        end
    end
})
...
Rayfield:Notify({
    Title = "Готово",
    Content = "Цветной мир добавлен, скрипт полностью обновлен!",
    Duration = 3,
    Image = 4483362458,
})