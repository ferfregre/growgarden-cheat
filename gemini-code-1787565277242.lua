-- ============================================
-- @set9p | SILENT AIM (360°) + AUTO TRIGGER (INSTANT & CENTER FOV) + ESP + ANTI-AIM
-- ============================================
...
-- ============================
-- SILENT AIM & AUTO TRIGGER (ФОКУС НА ЦЕНТР ЕКРАНА)
-- ============================
local function GetClosestPlayer()
    ...
    for _, v in pairs(plrs) do
        ...
        if Settings.Aim360 then
            ...
            if onScreen then
                -- Считаем расстояние от центра экрана (прицела) до врага в пикселях
...
-- Мгновенный триггербот без задержек, выбирающий ближайшего к прицелу
...
CombatTab:CreateToggle({
    Name = "Auto Trigger (Мгновенный по центру)",
    CurrentValue = false,
...
Rayfield:Notify({
    Title = "@set9p",
    Content = "Скрипт обновлен: приоритет на центр экрана!",
    Duration = 3,
    Image = 4483362458,
})