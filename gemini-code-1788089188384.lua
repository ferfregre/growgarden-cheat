-- ============================================
-- @set9p | SILENT AIM + STRICT VISIBLE ONLY + AUTO TRIGGER + ESP + BHOP
-- ============================================
...
-- ============================
-- СТРОГАЯ ПРОВЕРКА ТОЛЬКО ПРЯМОЙ ВИДИМОСТИ
-- ============================
local function isDirectlyVisible(targetPart)
    ...
    -- Проверка общей дальности до цели
    ...
    -- Выстрел разрешен ТОЛЬКО если на пути нет преград (луч дошел до цели)
...
Rayfield:Notify({
    Title = "@set9p",
    Content = "Скрипт запущен: только прямая видимость, без прострелов!",
    Duration = 3,
    Image = 4483362458,
})